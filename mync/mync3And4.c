...
int main(int argc, char *argv[]) { 
    ...
    int timeout = 0;
    int i = 2; // because the first two arguments are the program name and the -e flag.
    ...
    program[0] = '\0';
    for (i = 2; i < argc && argv[i][0] != '-'; i++) { // extract the program string from argv.
...
5)  ./mync3And4 -e "./ttt 123456789" -i UDPS4050 -t 10
    nc -u localhost 4050

6)  ./mync3And4 -e "./ttt 123456789" -o UDPClocalhost,4050 -t 10
    nc -u -l -p 4455

7)  ./mync3And4 -e "./ttt 123456789" -i UDPS4050 -o UDPClocalhost4455 -t 10
    nc -l 4455
    nc localhost 4050
*/
